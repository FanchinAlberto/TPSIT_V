...
public class WarehouseThread extends Thread {
    ...
    private String protocol(String command) {
        ...
        component = command.split(","); // separazione della stringa nelle componenti
                ...
                if (n > 0) {
                    ...
                    for (i=0; i<n; i++) {
                        if (buffer[i] == '\r' || buffer[i] == '\n') {
                            // commando ricevuto: esecuzione e risposta
                            ...
                            // trasformazione dei caratteri ricevuti in formato Unicode e costruzione del comando carattere per carattere
